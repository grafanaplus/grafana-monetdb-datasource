...
export class MonetQueryCtrl extends QueryCtrl {
  ...
  constructor($scope, $injector, private templateSrv, private $q, private uiSegmentSrv)  {
    ...
    this.queryModel = new MonetQuery(this.target, templateSrv, this.panel.scopedVars);
    this.queryBuilder = new MonetQueryBuilder(this.target, this.datasource.database);
